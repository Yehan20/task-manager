    ...
    <v-row class="align-start md:bg-primary">
      <v-col cols="12" sm="6">
        ...
        <v-date-picker
          ...
          elevation="0"
          width="100%"
          class="mb-2 shadow bg-grey-lighten-4"
          color="deep-purple-darken-4"
          title="Select Deadline"
        />

        <div v-for="error in deadline.errors.value" :key="error" class="text-error mb-6 text-xm">
          {{ error }}
        </div>
      </v-col>
      ...
      <v-col cols="12" sm="6" class="">
        ...
        <BaseInputFeild
          ...
          :errorMessages="title.errors.value"
          label="Title"
        />
        ...
        <v-textarea
          ...
          :max-errors="description.errors.value.length"
          label="Description"
          auto-grow
        >
        </v-textarea>
        ...
        <v-select
          ...
          variant="outlined"
          density="comfortable"
          :error-messages="priority.errors.value"
          :max-errors="priority.errors.value.length"
        ...
        <v-select
          ...
          variant="outlined"
          density="comfortable"
          :error-messages="status.errors.value"
          :max-errors="status.errors.value.length"
        ...
        <div>
          <v-alert
            ...
            position="static"
            closable
            :icon="alertColor === 'success' ? 'mdi-check-circle' : 'mdi-alert'"
            :text="alertMessage"
            :type="alertColor"
          />
        </div>
