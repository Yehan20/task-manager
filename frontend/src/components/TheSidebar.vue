...
<template>
  ...
  >
    ...
    <v-list class="pa-0 mt-4">
      <v-btn
        ...
        :to="item.value"
        variant="text"
        class="text-left justify-start w-100 mb-3 px-4 py-2 rounded"
        :ripple="false"
        exact
        link
  ...
  <v-navigation-drawer
    v-if="!mdAndDown"
    class="pa-5 bg-deep-purple-darken-4 pb-2x text-center"
    theme="dark"
    style=""
    permanant
  >
    ...
    <v-list class="pa-0 mt-4">
      <v-btn
        ...
        :to="item.value"
        variant="text"
        class="text-cemter justify-center w-100 mb-3 px-4 py-2 rounded"
        :ripple="false"
        exact
        link
        exact-active-class="border-b-2 border-purple"
